    ...
    return (
        <div className="bg-white py-24 px-12 lg:px-24 flex flex-col lg:flex-row items-center justify-between text-white gap-12"> {/* Increased gap */}
            ...
            <div className="flex-1 lg:mr-12"> {/* Increased margin-right */}
                <h1 className="text-4xl lg:text-5xl font-bold mb-4 text-black">Customize it to your needs</h1>
                <p className="text-lg lg:text-xl mb-6 text-black">
                    Customize the apps with plugins,custom themes and multiple text editors. Or create your own scripts and plugins using the Extension API
                </p>
                <div className="my-3">
